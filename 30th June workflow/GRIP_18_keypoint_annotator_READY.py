...
DEFAULT_OUTPUT_NAME = "YOLO_pose_18kp_dataset"
...
#
# This is intentionally richer than the old 7-keypoint version:
# - 3 cuff/wrist points
# - 5 palm/polygon points
# - thumb base/tip
# - 4 finger bases/tips
#
# Keep this order fixed forever after you start annotating.
KEYPOINT_NAMES = [
    "cuff_thumb_side_edge",     # 0
    "cuff_center",              # 1
    "cuff_pinky_side_edge",     # 2

    "palm_lower_thumb_corner",  # 3
    "palm_lower_pinky_corner",  # 4
    "palm_upper_thumb_corner",  # 5
    "palm_upper_pinky_corner",  # 6
    "palm_center",              # 7
...
# This draws the palm polygon, cuff, finger chains, and palm center spokes.
SKELETON_EDGES = [
    # cuff line
    (0, 1), (1, 2),
...
KEYPOINT_COLORS = [
    (255, 255, 255),  # 0 cuff thumb side
    (0, 255, 255),    # 1 cuff center
    (255, 255, 255),  # 2 cuff pinky side

    (255, 180, 0),    # 3 palm lower thumb
    (255, 180, 0),    # 4 palm lower pinky
    (255, 220, 0),    # 5 palm upper thumb
    (255, 220, 0),    # 6 palm upper pinky
    (0, 255, 255),    # 7 palm center

    (255, 0, 255),    # 8 thumb base
    (255, 0, 255),    # 9 thumb tip

    (0, 255, 0),      # 10 index base
    (0, 255, 0),      # 11 index tip

    (255, 255, 0),    # 12 middle base
    (255, 255, 0),    # 13 middle tip

    (255, 128, 0),    # 14 ring base
    (255, 128, 0),    # 15 ring tip

    (0, 128, 255),    # 16 pinky base
    (0, 128, 255),    # 17 pinky tip
]
...
def write_docs(paths):
    ...
    readme.write_text(
        f"""# GRIP YOLO-Pose 18-Keypoint Dataset
...
class PoseAnnotator:
    ...
    def bind_events(self):
        ...
        # For keypoints 10-18, use the keypoint list on the right panel.
...
class MainApp:
    ...
    def build_ui(self):
        ...
        ttk.Button(buttons, text="2. Open YOLO-Pose Annotator", command=self.open_annotator).pack(fill=tk.X, pady=4)
        ...
        info = (
            ...
            "2. Annotate each glove with class + bbox + 18 keypoints.\n"
