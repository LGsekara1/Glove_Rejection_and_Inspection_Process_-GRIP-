...
#define ODrive_NRST_Pin GPIO_PIN_4
#define ODrive_NRST_GPIO_Port GPIOC
#define Relay_EN_Pin GPIO_PIN_5
...
#define Display_RX_GPIO_Port GPIOE
...
#define MCU_Pneu_3_Pin GPIO_PIN_8
#define MCU_Pneu_3_GPIO_Port GPIOC
#define MCU_Pneu_5_1_Pin GPIO_PIN_9
#define MCU_Pneu_5_1_GPIO_Port GPIOC
#define MCU_Pneu_5_2_Pin GPIO_PIN_8
